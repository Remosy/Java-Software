...
public class Simulate extends JPanel implements ActionListener, KeyListener,
	...
	JComboBox convert;
	int index; //0: Dec 1: to String 2:Ascii
	...
	public Simulate(boolean term, boolean echo, boolean profile) {
		...
		// Stage 2
		String[] convStrings = { "2s-complement integer", "Hex", "ASCII" };
		convert = new JComboBox(convStrings);
		convert.addItemListener(new ItemListener() {
			public void itemStateChanged(ItemEvent arg0) {
				switch (convert.getSelectedIndex()){
					case 0:
						setConvert(0);
						System.out.println("2s-complement integer");
						break;
					case 1:
						setConvert(1);
	...
	public void layoutContainer(Container arg0) {
		...
		convert.setBounds(r2x, (idx++) * rs.height, rs.width, rs.height);
