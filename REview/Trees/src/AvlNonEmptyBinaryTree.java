...
public class AvlNonEmptyBinaryTree extends NonEmptyBinaryTree {
	...
	private AvlNonEmptyBinaryTree rotateRL() {
		...
		return (new AvlNonEmptyBinaryTree(rl.data,new AvlNonEmptyBinaryTree(data,left,rl.left),
				new AvlNonEmptyBinaryTree(r.data,rl.right,r.right)));
	}
	...
	private AvlNonEmptyBinaryTree rotateLR() {
		...
		return (new AvlNonEmptyBinaryTree(lr.data,new AvlNonEmptyBinaryTree(l.data,l.left,lr.left),
				new AvlNonEmptyBinaryTree(data,lr.right,right)));
	}
}
