	...
	private class BinaryTreeTableNode {
		...
		public void insert(String id, String name) {
			if (id.equals(key)) {
				...
				if (left == null)  left =   new  BinaryTreeTableNode(id,name);
				else left.insert(id,name);
			} else  {
				if (right == null) right =  new BinaryTreeTableNode(id,name);
				else right.insert(id,name); } }}
