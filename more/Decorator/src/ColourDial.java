...
//public class ColourDial extends Dial implements MouseMotionListener, MouseListener {
public class ColourDial extends DialDecorator implements MouseMotionListener, MouseListener {
	...
	DialGUI dialgui;
	Integer dragStart;
	ClickDial clickDiall;
	
	public ColourDial(Color color, ClickDial clickDial) {
		this.color = color;
		value = 0.5;	
		dragStart = null;
		this.addMouseMotionListener(this);
		this.addMouseListener(this);
		this.clickDiall = clickDial;
	}
