...
//public class ClickDial extends Dial implements MouseMotionListener, MouseListener {
public class ClickDial extends DialDecorator implements MouseMotionListener, MouseListener {
	...
	public ClickDial(int clicks,SimpleDial simpleDial) {
		this.clicks = clicks;
		value = 0.5;	
		dragStart = null;
	...
	public double value() {
		return ((double) Math.round(value * clicks)) / clicks;
	}
